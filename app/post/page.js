                    ...
                    <table className="w-full border border-gray-200">
                        <thead>
                            <tr className="w-full bg-gray-200">                           
                                  <th className="text-center border-b border-gray-200 px-4 py-2">Name (Engilish)</th>
                            ...
                            {posts.length ?(
                                posts.map(post => (
                                    <tr className="border-b border-gray-200 hover:bg-gray-100" key={post._id}>                                           
                                          <td className="text-center py-2 px-4">{post.nmEn}</td>
                                          <td className="text-center py-2 px-4 font-sutonnyN">{post.nmBn}</td>                                            
