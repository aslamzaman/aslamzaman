...
export const PUT = async (Request,{ params }) => {
  try {
    ...
    const staffs = await StaffModel.findOneAndUpdate({ _id: id }, { nmEn, nmBn, joinDt, mobile, genderId, postId, projectId, pictureUrl, empId, placeId, unitId, status, remarks, salary });
    return NextResponse.json(staffs);
  } catch (err) {
