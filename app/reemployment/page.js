  ...
  return (
    <>
      <div className="w-full mb-3 mt-8">
        <h1 className="w-full text-xl lg:text-3xl font-bold text-center text-blue-700">Re-employment of part-time staff</h1>
              ...
              <table className="w-full border border-gray-200">
                <thead>
                  <tr className="w-full bg-gray-200">
                    <th className="text-start border-b border-gray-200 py-2 pl-6">Name</th>
                    <th className="text-center border-b border-gray-200 py-2">Duration</th>
                    <th className="text-center border-b border-gray-200 py-2">Past Reminder</th>
                    <th className="text-center border-b border-gray-200 py-2">New Reminder</th>
